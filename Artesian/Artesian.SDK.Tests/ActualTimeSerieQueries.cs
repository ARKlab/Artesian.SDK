    ...
    public class ActualTimeSerieQueries
    {
        ...
        public async Task ActInRelativeIntervalExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Day/RollingMonth")
        ...
        public async Task ActInRelativePeriodExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Day/P5D")
                    .WithVerb(HttpMethod.Get)
                    .WithQueryParam("id", 100000001)
                    .Times(1);
            }
        ...
        public async Task ActInRelativePeriodRangeExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Day/P2W/P20D")
                    .WithVerb(HttpMethod.Get)
                    .WithQueryParam("id", 100000001)
                    .Times(1);
            }
        ...
        public async Task ActMultipleMarketDataWindow()
        {
            ...
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Month/P2W/P6M")
                    .WithVerb(HttpMethod.Get)
                    .WithQueryParamMultiple("id", new [] { 100000001, 100000002, 100000003 })
                    .Times(1);
            }
        ...
        public async Task ActWithTimeZone()
        {
            ...
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Hour/2018-01-01/2018-01-10")
                    .WithVerb(HttpMethod.Get)
                    .WithQueryParam("id", 100000001)
...
#pragma warning restore MA0144 // Use System.OperatingSystem to check the current OS
        ...
        public async Task FillerNoneActInAbsoluteDateRangeMostRecent()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/ts/Day/2018-06-22/2018-07-23")
                 .WithQueryParam("id", 100000001)
