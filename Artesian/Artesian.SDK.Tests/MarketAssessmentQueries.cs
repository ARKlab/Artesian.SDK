    ...
    public class MarketAssessmentQueries
    {
        ...
        public async Task MasInRelativeIntervalExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/mas/RollingMonth")
        ...
        public async Task MasInAbsoluteDateRangeExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/mas/2018-01-01/2018-01-10")
                    .WithQueryParam("id", 100000001)
                    .WithQueryParamMultiple("p", new [] { "M+1", "GY+1" })
                    .WithVerb(HttpMethod.Get)
                    .Times(1);
        ...
        public async Task MasInRelativePeriodExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/mas/P5D")
                    .WithQueryParam("id", 100000001)
                    .WithQueryParamMultiple("p", new [] { "M+1", "GY+1" })
                    .WithVerb(HttpMethod.Get)
                    .Times(1);
        ...
        public async Task MasInRelativePeriodRangeExtractionWindow()
        {
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/mas/P2W/P20D")
                    .WithQueryParam("id", 100000001)
                    .WithQueryParamMultiple("p", new [] { "M+1", "GY+1" })
                    .WithVerb(HttpMethod.Get)
                    .Times(1);
        ...
        public async Task MasMultipleMarketDataWindow()
        {
            ...
            using (var httpTest = new HttpTest())
            {
                ...
                httpTest.ShouldHaveCalledPath($"{_cfg.BaseAddress}query/v1.1-beta/mas/P2W/P6M")
