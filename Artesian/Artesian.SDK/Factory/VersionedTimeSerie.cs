...
namespace Artesian.SDK.Factory
{
    ...
    internal sealed class VersionedTimeSerie : ITimeserieWritable
    {
        ...
        /// <param name="ctk">The Cancellation Token</param> 
        /// <returns></returns>
        public async Task Delete(LocalDateTime rangeStart, LocalDateTime rangeEnd, LocalDateTime version, bool deferCommandExecution = false, bool deferDataGeneration = true, CancellationToken ctk = default)
        {
            Ensure.Any.IsNotNull(_entity);
