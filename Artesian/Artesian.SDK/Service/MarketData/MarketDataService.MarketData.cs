...
namespace Artesian.SDK.Service
{
    public partial class MarketDataService : IMarketDataService
    {
        ...
        /// <returns>MarketData Entity Output</returns>
        public Task<MarketDataEntity.Output> UpdateDerivedConfigurationAsync(int marketDataId, DerivedCfgMuv derivedCfg, bool force, CancellationToken ctk = default)
        {
        ...
        /// <param name="ctk">Cancellation Token</param>
        /// <returns>MarketData Entity Output</returns>
        public Task<MarketDataEntity.Output> UpdateDerivedConfigurationAsync(int marketDataId, DerivedCfgCoalesce derivedCfg, bool force, CancellationToken ctk = default)
        {
            var marketDataOutput = ReadMarketDataRegistryAsync(marketDataId, ctk).ConfigureAwait(true).GetAwaiter().GetResult();
        ...
        /// <param name="ctk">Cancellation Token</param>
        /// <returns>MarketData Entity Output</returns>
        public Task<MarketDataEntity.Output> UpdateDerivedConfigurationAsync(int marketDataId, DerivedCfgSum derivedCfg, bool force, CancellationToken ctk = default)
        {
            var marketDataOutput = ReadMarketDataRegistryAsync(marketDataId, ctk).ConfigureAwait(true).GetAwaiter().GetResult();
