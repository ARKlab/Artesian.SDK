...
```
DerivedCfg can be of type: DerivedCfgCoalesce, DerivedCfgSum, DerivedCfgMuv, DerivedCfgTransform.
...
In marketData a public readonly parameter DerivedCfg contains the four possible DerivedCfg types. In case the MarketData is Derived, only one of the four types is populated. The other two are null.

```csharp
marketData.DerivedCfg.DerivedCfgCoalesce
marketData.DerivedCfg.DerivedCfgTransform
